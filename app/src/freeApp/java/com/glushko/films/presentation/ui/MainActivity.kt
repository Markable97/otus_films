package com.glushko.films.presentation.ui
...
import com.glushko.films.presentation.ui.detail_film.FragmentDetailFilm.Companion.EXTRA_FILM_ID
import com.glushko.films.presentation.ui.detail_film.FragmentDetailFilm.Companion.EXTRA_FILM_NAME
import com.glushko.films.presentation.ui.exit_dialog.ExitDialog
import com.glushko.films.presentation.ui.exit_dialog.OnDialogListener
import com.glushko.films.presentation.ui.favorite.CallbackFragmentFavorites
import com.glushko.films.presentation.ui.favorite.FragmentFavorites
import com.glushko.films.presentation.ui.films.CallbackFragmentFilms
...
class MainActivity : AppCompatActivity(), OnDialogListener, CallbackFragmentFilms,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        LoggingHelper.log(
            Log.DEBUG,
            "Пришло от уведомления название фильма ${intent.getStringExtra(EXTRA_FILM_NAME)} \n " +
