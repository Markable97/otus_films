package com.glushko.films.presentation.services
...
class SeeLaterReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context?, intent: Intent?) {
        ...
        context?.let { _context ->
            ...
            val pendingIntent =
                PendingIntent.getActivity(_context, 0, intentNew, PendingIntent.FLAG_UPDATE_CURRENT)
            val builder = NotificationCompat.Builder(_context, CHANNEL_ID)
                ...
                .setStyle(
                    NotificationCompat.BigTextStyle()
                        .bigText(_context.getString(R.string.it_is_time_move_film, film))
                )
                .setPriority(NotificationCompat.PRIORITY_DEFAULT)
                .addAction(
                    R.drawable.ic_video_library,
                    _context.getString(R.string.open_film),
                    pendingIntent
                )
